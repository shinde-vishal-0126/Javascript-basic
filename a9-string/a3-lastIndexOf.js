...
// / lastindexOf(): the lastindexof() method return the index(position) of the last occurrence of a specified string value in a string or it return -1 if the string not found.
