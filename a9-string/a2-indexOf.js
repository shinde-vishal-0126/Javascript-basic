...
// indexOf(): the indexof() method return the index(position) of the first occurrence of a specified string value in a string or it return -1 if the string not found.


// 1. The indexOf() method in JavaScript is used to determine the first occurrence of a specified value within a string and return the index value of the specified value.
