...
//!1 in an object method : this refer to the object
const obj = {
  myAge: 27,
  myName: function() {
    console.log(
...
//! 2 alone : this refer to the Global object
console.log(this);
...
//!5 in a event : this refer to the element that received the event
...
// explicit object binding : explicit binding can we apply using the call, apply and bind method
// implicit object binding  (implicit binding apply when an invoke the function in an object using .(dot), notation )
...
// Arrow functions do not have their own this. Instead, they use the value of this from the surrounding lexical scope. If there is no surrounding context, this will refer to the global object (window).
