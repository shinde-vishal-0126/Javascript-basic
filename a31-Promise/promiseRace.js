//? promise.race()
// Promise.race() is a method in JavaScript that returns a promise which resolves or rejects as soon as any one of the promises in the iterable (array or collection) resolves or rejects.
//  It "races" the promises against each other, and the one that settles (resolves or rejects) first is the result.
...
//  Purpose: Promise.race() returns the first settled promise, whether resolved or rejected.
// Behavior: If one promise resolves or rejects, Promise.race() settles with that result immediately and ignores the remaining promises.
