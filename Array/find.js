...
// find() method return the first element in an array that satisfies a given condition. 
// find((ele,index, array)=>{})
// find() method return the value of the first element in the array where predicates is true
// if the value are not satisfied with give conditon it return undefined.
// found element in the array if some element in the array satisfied the given conditon
...
// here return the first element that satisfied the give conditon
console.log(find);


// example 
// if not satisfied the conditon then return undefined
...
// for element and index conditon 
...
// it return only 5 because find method return first element that match the given conditon 
// so insted of returning the multiple value it return only first occurrences of the return result
...
function findPrimeNumver(number, index, array) {
...
const firstPrime = numbers.find(findPrimeNumver);
// Output the result
...
const arr = [0,1, , , ,5,6];
// if you not defined any conditon then it by default return last element for the element and index 
const un = arr.find((element, index)=>{
    console.log(index, element);
})
// here return the undefined because we dont defined any condition
console.log(un);
