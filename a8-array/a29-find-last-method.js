...
// findLast(callback(ele, index, array));
// findindex() iterate an array in reverse order & return the value of the element that satisfied the Give condition or give test function
// if no element satisfied the condition it return undefined
