...
//? What are the events they are not bubbling ?
// Like focus, blur,  etc

// * Event bubbling and event capturing are two ways of event propagation in the html Dom api, when an event occurs an element inside another element and both elements have registered to handle  for the event.
...
//  It can be any descendant element within the target element, and it accurately identifies the element that triggered the event.( This is the actual element where the event occurred 
...
// This is the element that is currently handling the event, 
