...
//1 Create the Global Object (window in browsers, global in Node.js):
// In the browser, this is the window object.
// In Node.js, it's the global object.
//2 Set up the this binding:
// In the global execution context, this refers to the global object.
// Allocate memory for variables, functions, and objects in the Memory Heap:
//3 Function Declarations: These are stored fully in memory, meaning the entire function is available for use before the code executes.
//4 Variables (var, let, const): These are declared in memory:
//5 var variables are initialized with undefined.
//6 let and const are declared but not initialized (remain in the temporal dead zone (TDZ) until the code assigning them a value is executed).
