...
// class expresson do not required an identifier after the class keyword and you can used class expression in varialbe declaration in variable 
// declaration and pass it into a function as an argument 


//class expression start with the keyword class followed by the class defination
...
let person = new Person('vishla shinde');
