...
// Execution" 
// once the code is compiled the javascript engine execute it, during the execution the engine create execution context , manage the scope chain, handled various assignment and call function.
// the execution context consist 2 phase phase :
//1. first is creation phase (where variable and function are hoisted)
//2. execution phase :(where the code is actually run)
...
//
//! heap memory :
// the heap memory is where dynamically allocated memory residers. this is where objects, closures and other dynamically allocated data are stored.
...
// creating the variable environment and allocating memory for global variable and function
