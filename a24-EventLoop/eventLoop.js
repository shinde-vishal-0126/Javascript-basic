...
// 1.event loop continuously check the call stack and callback Queue or (monitoring both call stack and callback queue)
...
// call stack is mechanism to keep track of the function execution call in the program 
...
// Global execution context so this is default execution context
// in which js code start its execution when the file first load in the browser

// WHAT IS EXECUTION CONTEXT
//  the execution is an abstract concept of an environment were the  javascript code is evaluated and executed.
...
// 2 Web api --> web api having  setTimeOut(), Dom, ajax/api or 
// 3. message queue
...
// web api is browser api it take a long running task form the call stack and executed and pass to the task queue
// so in web api having multiple api like
// fetchApi ,
//Times Api (setTimeout, setInterval)
// console api
//Geolocation api (Geolocation, geolocation api)
// web storageAPi(localstorage, session storage)
// fileApi
// performances api
// html dom 
// url api