...
// Why does it happen?
// In non-strict mode (the default mode in JavaScript), if you assign a value to a variable without declaring it (i.e., without var, let, or const), JavaScript will automatically create it in the global scope. This behavior can lead to unintended bugs, especially in larger applications, where global variables are harder to track and can cause conflicts.